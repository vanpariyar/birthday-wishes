...
document.getElementById('birthday-person').innerText = ( params.name ) ? decodeURIComponent(params.name) : 'Friend'; 
...
document.getElementById('from-name').innerText = ( params.from ) ? decodeURIComponent(params.from) : `Your Friend`; 
